...
export function getInitialStudents(): StudentProfile[] {
  return [
    { id: 'st-hb-1', name: 'پارسا آسوده', firstName: 'پارسا', lastName: 'آسوده', className: 'هشتم ب', code: '1200362721', fatherName: 'مهدی', createdAt: '2024-09-23' },
    { id: 'st-hb-2', name: 'ارشیا افشاری', firstName: 'ارشیا', lastName: 'افشاری', className: 'هشتم ب', code: '1200362500', fatherName: 'علی قاسم', createdAt: '2024-09-23' },
    { id: 'st-hb-3', name: 'پارسا امیدی', firstName: 'پارسا', lastName: 'امیدی', className: 'هشتم ب', code: '1200366379', fatherName: 'اسماعیل', createdAt: '2024-09-23' },
    { id: 'st-hb-4', name: 'نیما امیدی', firstName: 'نیما', lastName: 'امیدی', className: 'هشتم ب', code: '1200364791', fatherName: 'سعید', createdAt: '2024-09-23' },
    { id: 'st-hb-5', name: 'مهدی باقری', firstName: 'مهدی', lastName: 'باقری', className: 'هشتم ب', code: '1200364341', fatherName: 'علی قربان', createdAt: '2024-09-23' },
    { id: 'st-hb-6', name: 'بردیا بهرامیان', firstName: 'بردیا', lastName: 'بهرامیان', className: 'هشتم ب', code: '1200359275', fatherName: 'صمد', createdAt: '2024-09-23' },
    { id: 'st-hb-7', name: 'کیارش بهرامیان', firstName: 'کیارش', lastName: 'بهرامیان', className: 'هشتم ب', code: '1200360796', fatherName: 'شهریار', createdAt: '2024-09-23' },
    { id: 'st-hb-8', name: 'امیرمحمد بهی روزنیا', firstName: 'امیرمحمد', lastName: 'بهی روزنیا', className: 'هشتم ب', code: '1200364996', fatherName: 'محمود', createdAt: '2024-09-23' },
    { id: 'st-hb-9', name: 'امیرعلی پیرمرادیان', firstName: 'امیرعلی', lastName: 'پیرمرادیان', className: 'هشتم ب', code: '1200365658', fatherName: 'محمدابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-10', name: 'محمدرضا جعفری', firstName: 'محمدرضا', lastName: 'جعفری', className: 'هشتم ب', code: '1200367863', fatherName: 'بابک', createdAt: '2024-09-23' },
    { id: 'st-hb-11', name: 'کوروش راجی', firstName: 'کوروش', lastName: 'راجی', className: 'هشتم ب', code: '1200360567', fatherName: 'حمید', createdAt: '2024-09-23' },
    { id: 'st-hb-12', name: 'علی رشیدی', firstName: 'علی', lastName: 'رشیدی', className: 'هشتم ب', code: '1200360494', fatherName: 'ابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-13', name: 'علی رشیدی (بهرام)', firstName: 'علی', lastName: 'رشیدی', className: 'هشتم ب', code: '1200361504', fatherName: 'بهرام', createdAt: '2024-09-23' },
    { id: 'st-hb-14', name: 'پوریا شهبازی', firstName: 'پوریا', lastName: 'شهبازی', className: 'هشتم ب', code: '1200367014', fatherName: 'محمود', createdAt: '2024-09-23' },
    { id: 'st-hb-15', name: 'امیرحسین صابری', firstName: 'امیرحسین', lastName: 'صابری', className: 'هشتم ب', code: '1277022852', fatherName: 'محمدابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-16', name: 'اشکان صاعدی', firstName: 'اشکان', lastName: 'صاعدی', className: 'هشتم ب', code: '1200368959', fatherName: 'ناصر', createdAt: '2024-09-23' },
    { id: 'st-hb-17', name: 'آدرین طاهری پور', firstName: 'آدرین', lastName: 'طاهری پور', className: 'هشتم ب', code: '1276919417', fatherName: 'یونس', createdAt: '2024-09-23' },
    { id: 'st-hb-18', name: 'مبین طائی', firstName: 'مبین', lastName: 'طائی', className: 'هشتم ب', code: '1200360011', fatherName: 'مجتبی', createdAt: '2024-09-23' },
    { id: 'st-hb-19', name: 'طاها طغرایی', firstName: 'طاها', lastName: 'طغرایی', className: 'هشتم ب', code: '1200361318', fatherName: 'پویا', createdAt: '2024-09-23' },
    { id: 'st-hb-20', name: 'علی قاسمی', firstName: 'علی', lastName: 'قاسمی', className: 'هشتم ب', code: '1200362934', fatherName: 'ابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-21', name: 'محمد قاسمی', firstName: 'محمد', lastName: 'قاسمی', className: 'هشتم ب', code: '1200362926', fatherName: 'ابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-22', name: 'هوتن قاسمی', firstName: 'هوتن', lastName: 'قاسمی', className: 'هشتم ب', code: '1190535963', fatherName: 'رضا', createdAt: '2024-09-23' },
    { id: 'st-hb-23', name: 'سیدآریا قائم مقامی', firstName: 'سیدآریا', lastName: 'قائم مقامی', className: 'هشتم ب', code: '1200360699', fatherName: 'سیدابراهیم', createdAt: '2024-09-23' },
    { id: 'st-hb-24', name: 'مهرسام کاوه', firstName: 'مهرسام', lastName: 'کاوه', className: 'هشتم ب', code: '1200368398', fatherName: 'محمد', createdAt: '2024-09-23' },
    { id: 'st-hb-25', name: 'امیرعلی منصورزاده', firstName: 'امیرعلی', lastName: 'منصورزاده', className: 'هشتم ب', code: '1200360818', fatherName: 'حمید', createdAt: '2024-09-23' },
    { id: 'st-hb-26', name: 'سیاوش نادری', firstName: 'سیاوش', lastName: 'نادری', className: 'هشتم ب', code: '1200363231', fatherName: 'محمد', createdAt: '2024-09-23' },
